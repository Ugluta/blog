...
const COLS = [
  ...
  },
  {
    title: "Çözümler",
    links: [
      { label: "Medya Şirketleri", href: "/cozumler/medya" },
      { label: "Ajanslar", href: "/cozumler/ajanslar" },
      { label: "Girişimciler", href: "/cozumler/girisimciler" },
      { label: "Kurumsal", href: "/cozumler/kurumsal" },
    ],
  },
  {
    title: "Kaynaklar",
...
export default function Footer() {
  return (
    <footer className="bg-[#070b15] border-t border-slate-800/60 mt-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[260px_1fr] gap-12 lg:gap-16">
          ...
          <div>
            ...
            <p className="text-sm text-slate-400 leading-relaxed mb-6 max-w-[220px]">
              İçerik üretimi, sosyal medya yönetimi ve yapay zeka destekli yayıncılık platformu.
            </p>
      ...
      <div className="border-t border-slate-800/60">
        <div className="max-w-screen-xl mx-auto px-5">
          <div className="flex flex-col sm:flex-row items-center justify-between py-5 gap-3 text-xs text-slate-600">
            ...
            <div className="flex items-center gap-5">
              ...
              <Link href="/kullanim-sartlari" className="hover:text-slate-400 transition-colors">Şartlar</Link>
              <Link href="/cerez-politikasi" className="hover:text-slate-400 transition-colors">Çerezler</Link>
              <Link href="/sitemap.xml" className="hover:text-slate-400 transition-colors">Site Haritası</Link>
            </div>
          </div>
        </div>
      </div>
