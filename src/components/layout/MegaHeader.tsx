        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16 gap-4">
            ...
            <form
              ...
              onSubmit={e => { e.preventDefault(); if (searchValue.trim()) router.push(`/arama?q=${encodeURIComponent(searchValue.trim())}`); }}
            >
      ...
      {mobileOpen && (
        <div className="lg:hidden bg-slate-800 border-b border-slate-700">
          ...
          <div className="px-4 pt-3 pb-2">
            <form onSubmit={e => { e.preventDefault(); const v = (e.currentTarget.querySelector("input") as HTMLInputElement).value.trim(); if (v) { router.push(`/arama?q=${encodeURIComponent(v)}`); setMobileOpen(false); } }}>
              <div className="relative">
                <input
                  type="text"
                  placeholder="Ara..."
