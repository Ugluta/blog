...
export const heroNewsItems: HeroNewsItem[] = [
  ...
  {
    id: 4,
    title: "İklim Krizi Zirvesi Sonuç Bildirgesinde Petrol Şirketlerine Tarihi Yaptırım",
    excerpt: "BM İklim Zirvesi'nde alınan kararlar çerçevesinde fosil yakıt şirketleri, iklim zararları için yıllık 200 milyar dolar tazminat ödemekle yükümlü tutuldu.",
    category: "Dünya",
  ...
  {
    id: 5,
    title: "Türk Spor Kulüpleri Borsada: Galatasaray Hisseleri Yüzde 40 Değer Kazandı",
    excerpt: "Şampiyonlar Ligi'ndeki başarıların ardından Türk futbol kulüplerinin borsa performansı yatırımcıların dikkatini çekiyor.",
    category: "Spor",
...
export const recentPosts: RecentPost[] = [
  ...
  { id: 3, title: "Türk Futbolunda Yabancı Sınırı Tartışması", date: "16 Haz 2026", image: "https://picsum.photos/60/60?random=83", category: "Spor" },
...
export const mostCommentedPosts: CommentedPost[] = [
  ...
  { id: 3, title: "Galatasaray'ın Şampiyonlar Ligi Serüveni", category: "Spor", commentCount: 256 },
