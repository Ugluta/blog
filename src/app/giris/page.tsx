...
function LoginForm() {
  ...
  const callbackUrl = searchParams.get("callbackUrl") ?? "/uygulama";
  ...
  const [error, setError] = useState(
    errorParam === "OAuthAccountNotLinked"
      ? "Bu e-posta başka bir yöntemle kayıtlı. O yöntemle giriş yapın."
        ...
        <div className="bg-[#1E293B] rounded-2xl border border-slate-700/50 p-8 shadow-2xl">
          ...
          <div className="grid grid-cols-3 gap-2 mb-6">
            {SOCIAL_PROVIDERS.map((p) => (
              <button
                ...
                title={`${p.label} ile giriş yap`}
                className={`flex flex-col items-center gap-1.5 py-3 rounded-xl border border-slate-700/60 text-slate-300 transition-all disabled:opacity-50 ${p.bg} hover:border-slate-500`}
              >
                {socialLoading === p.id ? (
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs text-slate-500">
              <span className="bg-[#1E293B] px-3">veya e-posta ile</span>
            </div>
          </div>
