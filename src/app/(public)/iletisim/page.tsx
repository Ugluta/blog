      ...
      <main>
        <section className="border-b border-gray-100 py-14 px-4">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-gray-500">Sorularınız, önerileriniz veya teknik destek için bize ulaşın.</p>
          </div>
        </section>
          ...
          <div className="max-w-5xl mx-auto grid md:grid-cols-3 gap-10">
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <p className="text-sm font-semibold text-gray-900 mb-0.5">Destek Konuları</p>
                  <p className="text-sm text-gray-500">Teknik sorunlar, üyelik, içerik bildirimi, öneri</p>
                </div>
              </div>
            </div>
            ...
            <div className="md:col-span-2">
              {status === 'sent' ? (
                <div className="bg-green-50 border border-green-100 rounded-2xl p-8 text-center">
                  ...
                  <p className="text-sm text-gray-500">En kısa sürede size geri döneceğiz.</p>
                </div>
              ) : (
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full h-11 px-4 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500"
