          ...
          {user.files.length > 0 && (
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-lg font-bold text-gray-900">Son Yüklenen Dosyalar</h2>
                <Link href="/dosyalarim" className="text-sm text-blue-600 hover:text-blue-700">
                  Tümünü Gör →
                </Link>
              </div>
